...
We add noise by replacing every utterance in the context (exept the last one) with a different utterance (from somewhere else in the dataset) based on the probability $P$.
